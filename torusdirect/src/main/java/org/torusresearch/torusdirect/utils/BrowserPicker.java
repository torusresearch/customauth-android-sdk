 ...
 *
 * See: https://github.com/auth0/Auth0.Android/blob/main/auth0/src/main/java/com/auth0/android/provider/BrowserPicker.java
 */
public class BrowserPicker {
    ...
    @Nullable
    public String getBestBrowserPackage(@NonNull PackageManager pm) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://customauth.io"));
