...
//            put("torus_passwordless", new LoginVerifier("Torus Passwordless", LoginType.JWT, "KG7zk89X3QgttSyX9NJ4fGEyFNhOcJTw", "tkey-auth0-email-passwordless-cyan", "auth.openlogin.com", "name", false));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomAuthArgs args = new CustomAuthArgs("https://scripts.toruswallet.io/redirect.html", Web3AuthNetwork.SAPPHIRE_MAINNET, "torusapp://org.torusresearch.customauthandroid/redirect", true, null, "YOUR_CLIENT_ID", 0);
